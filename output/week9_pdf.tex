...
\textbf{Visualization}
\includegraphics{/Volumes/GoogleDrive/My Drive/Classes/2019-2020 (Third Year)/Spring 2020/Data Science/Week 9/week9/output/week9_pdf_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mean\_cor \textless{}{-}}\StringTok{ }\KeywordTok{cor.test}\NormalTok{(week9\_tbl\_clean}\OperatorTok{$}\NormalTok{Q1Q5means, week9\_tbl\_clean}\OperatorTok{$}\NormalTok{Q6Q10means)}
\NormalTok{mean\_cor}\OperatorTok{$}\NormalTok{estimate}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mean\_cor}\OperatorTok{$}\NormalTok{p.value}
\end{Highlighting}
\end{Shaded}
